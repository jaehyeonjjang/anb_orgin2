...
public class CompanySpecs {
    ...
    public static Specification<Company> searchWith(Map<SearchKey, Object> searchKeyword) {
    ...
    private static List<Predicate> getPredicateWithKeyword(Map<SearchKey, Object> searchKeyword, Root<Company> root, CriteriaBuilder builder) {
