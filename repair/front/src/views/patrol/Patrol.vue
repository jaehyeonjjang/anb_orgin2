<template>
  ...
  <el-table :data="data.items" border style="width: 100%;" :height="height(170)" v-infinite="getItems" @row-click="clickUpdate" >
    ...
    <el-table-column prop="startdate" label="시작 시간" align="center" width="160" />
    <el-table-column prop="enddate" label="종료 시간" align="center" width="160" />
    <el-table-column label="상태" align="center" width="60">
          <template #default="scope">
            <span v-if="scope.row.status == 2">완료</span>
