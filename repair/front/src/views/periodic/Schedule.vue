<template>
  ...
  <y-table>
    <y-tr>
      <y-th>사전조사</y-th>
      <y-td>{{viewDuration(data.periodic.prestartdate, data.periodic.preenddate)}}</y-td>
    </y-tr>
    <y-tr>
      <y-th>현장조사</y-th>
      <y-td>{{viewDuration(data.periodic.researchstartdate, data.periodic.researchenddate)}}</y-td>
    </y-tr>
    <y-tr>
      <y-th>수집자료 및 결과 분석</y-th>
      <y-td>{{viewDuration(data.periodic.analyzestartdate, data.periodic.analyzeenddate)}}</y-td>
    </y-tr>
    <y-tr>
      <y-th>상태평가</y-th>
      <y-td>{{viewDuration(data.periodic.ratingstartdate, data.periodic.ratingenddate)}}</y-td>
    </y-tr>
    <y-tr>
      <y-th>보고서 작성</y-th>
      <y-td>{{viewDuration(data.periodic.writestartdate, data.periodic.writeenddate)}}</y-td>
    </y-tr>
    <y-tr>
      <y-th>보고서 인쇄 및 제출</y-th>
      <y-td>{{viewDuration(data.periodic.printstartdate, data.periodic.printenddate)}}</y-td>
    </y-tr>
  </y-table>
