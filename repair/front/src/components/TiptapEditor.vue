<template>
  <div id="text-editor">
    <div class="toolbar" v-if="editor">
      <button><div @click="onColorClick('#000000')" style="border-radius:2px;width:20px;height:16px;background:#000000;"></div></button>
      <button style="margin-left:-5px;"><div @click="onColorClick('#CC0000')" style="border-radius:2px;width:20px;height:16px;background:#CC0000;"></div></button>
      <button style="margin-left:-5px;"><div @click="onColorClick('#009900')" style="border-radius:2px;width:20px;height:16px;background:#009900;"></div></button>
      <button style="margin-left:-5px;"><div @click="onColorClick('#000099')" style="border-radius:2px;width:20px;height:16px;background:#000099;"></div></button>      
      <button 
    ...
    <div style="height:150px;overflow:auto;padding:10px 10px;background:#FFFFFF;" @click="editor.chain().focus()">
