...
import { Category, Dong, Standard, History, Breakdown, Totalreport, Yearreport, Repair } from "~/models"
...
async function getItems() {
  ...
  res = await Yearreport.find({
    page: data.page,
    pagesize: data.pagesize,
    apt: data.apt,
    orderby: 'b_duedate,b_topcategory,b_subcategory,b_category,b_standard,b_method'
  })
  ...
  let d = new Date()
  let year = util.getInt(data.repair.reportdate)
