...
class SettingScreen extends CWidget {
  ...
  build(BuildContext context) {
    return CScaffold(appBar: DefaultAppBar(), body: Obx(() => body()));
  }
  ...
  clickSave() async {
    ...
    autoController.autosave = c.autosave;
    autoController.zoomlevel = c.zoomlevel;
    autoController.autoclose = c.autoclose;
