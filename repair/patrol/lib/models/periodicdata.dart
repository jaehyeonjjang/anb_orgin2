...
class Periodicdata { 
  ...
  Map<String, dynamic> toJson() =>
      { 'id': id,'group': group,'type': type,'part': part,'member': member,'shape': shape,'width': width,'length': length,'count': count,'progress': progress,'remark': remark,'order': order,'content': content,'status': status,'filename': filename,'offlinefilename': offlinefilename,'blueprint': blueprint.id,'periodic': periodic,'date': date };
}
