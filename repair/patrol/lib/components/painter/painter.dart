...
import 'package:patrol/components/painter/painter_drawer.dart';
import 'package:patrol/components/painter/widgets/data_box.dart';
import 'package:patrol/components/painter/widgets/group_box.dart';
import 'package:patrol/components/painter/widgets/tool_box.dart';
...
class Painter extends StatelessWidget {
  ...
  Widget _menu(context) {
    return Row(children: [
      ...
      IconButton(
          icon: const Icon(Icons.apps_outlined, size: 30.0),
          onPressed: () => c.toolboxToggle()),
  ...
  void onSelectEnd(MoveEvent event) {
    ...
    for (var i = 0; i < c.points.length; i++) {
      ...
      for (var j = 0; j < points.items.length; j++) {
        ...
        if (points.type == DrawType.number || points.type == DrawType.icon) {
