...
type TotalyearreportController struct {
	controllers.Controller
}



func (c *TotalyearreportController) CountByApt(apt int64) int {
    
    conn := c.NewConnection()

	_manager := models.NewTotalyearreportManager(conn)
...
func (c *TotalyearreportController) FindByApt(apt int64) []models.Totalyearreport {
...
func (c *TotalyearreportController) Count() {
    
    
	conn := c.NewConnection()

	manager := models.NewTotalyearreportManager(conn)
...
func (c *TotalyearreportController) Read(id int64) {
...
func (c *TotalyearreportController) Index(page int, pagesize int) {
...
func (c *TotalyearreportController) Sum() {
