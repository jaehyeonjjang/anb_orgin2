...
type AptperiodicController struct {
	controllers.Controller
}



func (c *AptperiodicController) Insert(item *models.Aptperiodic) {
    
    
	conn := c.NewConnection()
    
	manager := models.NewAptperiodicManager(conn)
...
func (c *AptperiodicController) Insertbatch(item *[]models.Aptperiodic) {  
...
func (c *AptperiodicController) Update(item *models.Aptperiodic) {
...
func (c *AptperiodicController) Delete(item *models.Aptperiodic) {
...
func (c *AptperiodicController) Deletebatch(item *[]models.Aptperiodic) {
...
func (c *AptperiodicController) Count() {
    ...
    _outline7content := c.Get("outline7content")
    if _outline7content != "" {
        args = append(args, models.Where{Column:"outline7content", Value:_outline7content, Compare:"="})
    }
    ...
    _outline9content := c.Get("outline9content")
    if _outline9content != "" {
        args = append(args, models.Where{Column:"outline9content", Value:_outline9content, Compare:"="})
    }
...
func (c *AptperiodicController) Read(id int64) {
...
func (c *AptperiodicController) Index(page int, pagesize int) {
