...
type TotalreportController struct {
	controllers.Controller
}



func (c *TotalreportController) CountByApt(apt int64) int {
    
    conn := c.NewConnection()

	_manager := models.NewTotalreportManager(conn)
...
func (c *TotalreportController) FindByApt(apt int64) []models.Totalreport {
...
func (c *TotalreportController) Count() {
    
    
	conn := c.NewConnection()

	manager := models.NewTotalreportManager(conn)
...
func (c *TotalreportController) Read(id int64) {
...
func (c *TotalreportController) Index(page int, pagesize int) {
...
func (c *TotalreportController) Sum() {
