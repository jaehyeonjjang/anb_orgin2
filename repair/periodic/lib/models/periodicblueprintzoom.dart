...
class Periodicblueprintzoom { 
  ...
  factory Periodicblueprintzoom.fromJson(Map<String, dynamic> json) {
    return Periodicblueprintzoom(
        ...
        numberzoom: json['numberzoom'] as double,
        crackzoom: json['crackzoom'] as double,
  ...
  Map<String, dynamic> toJson() =>
      { 'id': id,'iconzoom': iconzoom,'numberzoom': numberzoom,'crackzoom': crackzoom, 'zoom': zoom,'status': status,'blueprint': blueprint,'periodic': periodic,'date': date };
}
